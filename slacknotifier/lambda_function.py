...
def lambda_handler(event, context):
    ...
    webhook_url = '** You Slack Channel Webhook **' # Set destination URL here

    slack_data = CloudWatchAlarmParser(sns_message).slack_data()
    slack_data["channel"] = 'You Slack Channel name '
    ...
    response = urlopen(request,ssl.create_default_context(cafile=certifi.where()))
    return {
